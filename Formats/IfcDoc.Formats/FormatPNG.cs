...
namespace IfcDoc.Format.PNG
{
	public class FormatPNG
	{
		...
		/// <returns></returns>
		public static Image CreateConceptDiagram(DocEntity docEntity, DocModelView docView, Dictionary<Rectangle, SEntity> layout, DocProject docProject, object instance)
		{
		...
		/// <returns></returns>
		public static Image CreateTemplateDiagram(DocTemplateDefinition docTemplate, Dictionary<Rectangle, SEntity> layout, DocProject docProject, object instance)
		{
		...
		public static Image CreateSchemaDiagram(DocSchema docSchema, DocProject docProject, DiagramFormat format)
		{
			float pageX = (float)DocSchema.PageX;
			float pageY = (float)DocSchema.PageY;
